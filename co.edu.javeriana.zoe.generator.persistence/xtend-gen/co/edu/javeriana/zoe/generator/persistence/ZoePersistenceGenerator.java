...
public class ZoePersistenceGenerator extends GeneratorSuite {
  ...
  public Set<? extends SimpleGenerator<?>> getGenerators() {
    ...
    return Collections.<SimpleGenerator<?>>unmodifiableSet(CollectionLiterals.<SimpleGenerator<?>>newHashSet(_entityGenerator, _resourceBundleGenerator, _enumGenerator, _dTOGenerator));
  }
}
